var columns = 10,
  rows = 20; //Классические размеры стакана
var board = []; //Стакан
var lose; //Конец игры
...
var colors = [ //Массив цветов
  '#008b8b', '#ff8c00', '#00008b', '#fdee00', '	#e30022', '	#00cc99', '	#8b008b'
];
var shaped = 0; //Есть ли следующая фигурка
var savedShape; //Следующая фигурка

function drawNewShape(current) { //Нарисовать следующую фигуру на отдельном канвасе
